...
import {
    BarChart, Bar, Cell, YAxis, Legend,
} from 'recharts';
...
const PersonalAccount = (props) => {
    const data = [
        {name: 'Январь', sum: 56000},
        {name: 'Февраль', sum: 36000},
        {name: 'Март', sum: 6000},
        {name: 'Апрель', sum: 12000},
        {name: 'Май', sum: 16000},
        {name: 'Июнь', sum: 23000},
        {name: 'Июль', sum: 56000},
        {name: 'Август', sum: 36000},
        {name: 'Сентябрь', sum: 6000},
        {name: 'Октябрь', sum: 12000},
        {name: 'Ноябрь', sum: 16000},
        {name: 'Декабрь', sum: 23000},
    ];
    return <div className={'container-fluid' + ' ' + classes.mainBlock}>
        <div className={'container'}>
                    ...
                    <div className={classes.blockCard}>
                        <div className={'row'}>
                            <div className={'col-8 ' + ' ' + classes.blockElement}>
                                ...
                                <div className="h5 mb-0 font-weight-bold text-gray-800">₽56,000</div>
                            </div>
                            <div className={'col-4 text-right pr-4 mt-3'}>
                                <MoneyIcon/>
                            </div>
                    ...
                    <div className={classes.blockCard}>
                        <div className={'row'}>
                            <div className={'col-8 ' + ' ' + classes.blockElement}>
                                ...
                                <div className="h5 mb-0 font-weight-bold text-gray-800">₽10,000</div>
                            </div>
                            <div className={'col-4 text-right pr-4 mt-3'}>
                                <CardIcon/>
                            </div>
            ...
            <div className={'row mr-0 ml-0 mb-3' + ' ' +classes.blockPayment }>
                ...
                <div className={'col-lg-12 col-12 mb-3'}>
                    <ResponsiveContainer width='100%' aspect={6.0 / 3.0}>
                        ...
                        >
                            ...
                            <Legend/>
                            {/*<Bar dataKey="pv" stackId="a" fill="#8884d8"/>*/}
                            <Bar dataKey="sum" name={'Количество заказов'} stackId="a" fill="#0085FF"/>
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            </div>
                ...
                <div className={'col-lg-4 mb-3'}>
                    <div className={'row mr-0 ml-0' + ' ' + classes.blockCardProfile}>
                        <div className={'col-12 pl-0 pr-0'}>
                            <img className={classes.blockFoto} src={'http://fzadmin-angular.fzthemes.site/assets/images/background6.webp'}/>
                        </div>
                        <div className={'col-12 text-center'}>
                            <div className={classes.fotoProfile}>
                                <img className={classes.imgProfile} src={'http://fzadmin-angular.fzthemes.site/assets/images/user-profile.webp'}/>
                            </div>
                        </div>
                                ...
                                <div className={'col-4 text-center'}>
                                    <NavLink title={'Сообщения'} to={'/setting'} >
                                        <svg className={classes.linkPush} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                             width="40" height="40"
                                             viewBox="0 0 172 172"
                                             ><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#cccccc"><path d="M86,17.2c-41.16533,0 -74.53333,28.23667 -74.53333,63.06667c0,15.34321 6.49141,29.3896 17.25599,40.3237c0.21737,0.54076 5.74049,14.75457 -10.61562,29.24896c-0.57911,0.5424 -0.90751,1.30056 -0.90703,2.09401c0,1.58322 1.28345,2.86667 2.86667,2.86667c0.20712,-0.00008 0.41362,-0.02261 0.61589,-0.06719c16.48827,-0.97682 30.59327,-9.15924 39.2039,-15.46432c8.13786,2.58069 16.91055,4.06484 26.11354,4.06484c41.16533,0 74.53333,-28.23667 74.53333,-63.06667c0,-34.83 -33.368,-63.06667 -74.53333,-63.06667z"></path></g></g></svg></NavLink>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className={'row'}>
                                <div className={'col-12'}>
                                    <div className={'row mr-0 ml-0 mb-3' + ' ' + classes.blockCompany}>
                                        <div className={'col-12 pl-0 pr-0'}>
                                            <img className={classes.blockFotoCompany} src={'https://avtoperevozki-msk.ru/upload/img/gruzoperevozka_deshevo.jpg'}/>
                                        </div>
                                        <div className={'col-12 text-center' + ' ' + classes.blockImg}>
                                            <img className={classes.imgCompany} src={'https://yt3.ggpht.com/a/AATXAJwMZq8jMbf5AzDQm6hHuZk_n4a6YavCGnef7w=s900-c-k-c0xffffffff-no-rj-mo'}/>
                                        </div>
                                        <div className={'col-12 text-center'}>
                                            <label>
                                                Trans-Siberian
                        ...
                        <div className={'col-lg-4' }>
                            <div className={'row'}>
                                <div className={'col-12'}>
                                    <div className={'row mr-0 ml-0 mb-3' + ' ' + classes.blockCompany}>
                                        <div className={'col-12 pl-0 pr-0'}>
                                            <img className={classes.blockFotoCompany} src={'https://i.pinimg.com/originals/cc/d2/0f/ccd20f29431606dafc48d631c74337ed.jpg'}/>
                                        </div>
                                        <div className={'col-12 text-center' + ' ' + classes.blockImg}>
                                            <img className={classes.imgCompany} src={'https://im0-tub-ru.yandex.net/i?id=49707a9609a3ac9d20fdc60046e01291&n=13&exp=1'}/>
                                        </div>
                                        <div className={'col-12 text-center'}>
                                            <label>
                                                Эдельвейс
                        ...
                        <div className={'col-lg-4' }>
                            <div className={'row'}>
                                <div className={'col-12'}>
                                    <div className={'row mr-0 ml-0 mb-3' + ' ' + classes.blockCompany}>
                                        <div className={'col-12 pl-0 pr-0'}>
                                            <img className={classes.blockFotoCompany} src={'https://im0-tub-ru.yandex.net/i?id=1d2f14e5c0992c9adce7e5e28fbac028&n=13&exp=1'}/>
                                        </div>
                                        <div className={'col-12 text-center' + ' ' + classes.blockImg}>
                                            <img className={classes.imgCompany} src={'https://yandex.ru/images/_crpd/1V0IlJ586/b9acad3oe44/NlbIqPpgHHNBEq_Oh51_HmugUt8UhUBwMbA_wjvNmBtvR495qMzx-9svylal7223mLaECieUgXRv5u2aIGTv7DYRXC35t043VJD42U'}/>
                                        </div>
                                        <div className={'col-12 text-center'}>
                                            <label>
                                                Convoy Trans
